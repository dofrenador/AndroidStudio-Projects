package alihanadrian.academy.calculator
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var result: EditText  //lateinitizatlion yapmak icin lateinit kullandik. "= null" hata veriyor. Thats the way for kotlin
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //We could also store buttons in an array and loop through this to assign listeners to them.
    ...
    //saves the data when going from landscape---> portrait and vice versa
